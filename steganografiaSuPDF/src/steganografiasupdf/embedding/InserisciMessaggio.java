...
public class InserisciMessaggio extends AbstractAction{
    ...
    //IMMAGINI:
    //immagine 4x4 -> 00
    //private final String immagine1 = "./src/steganografiasupdf/embedding/input/immaginiColorate/immagine1.jpg";
    private final String immagine1 = "embedding/input/immaginiBianche/immagine1.jpg";
    //immagine 8x8-> 01
    //private final String immagine2 = "./src/steganografiasupdf/embedding/input/immaginiColorate/immagine2.jpg";
    private final String immagine2 = "embedding/input/immaginiBianche/immagine2.jpg";
    //immagine 16x16 -> 10
    //private final String immagine3 = "./src/steganografiasupdf/embedding/input/immaginiColorate/immagine3.jpg";
    private final String immagine3 = "embedding/input/immaginiBianche/immagine3.jpg";
    //immagine 32x32 -> 11
    //private final String immagine4 = "./src/steganografiasupdf/embedding/input/immaginiColorate/immagine4.jpg";
            ...
            for(int i = 1; i <= reader.getXrefSize(); i++){
                ...
                if(pdfo != null && pdfo.isStream()){
                    ...
                    if(type != null && type.toString().equals(PdfName.IMAGE.toString())){
                        ...
                        String path = "embedding/immaginiCoverF5/" + "immagine_" 
                                + numImmagini + ".jpg";
